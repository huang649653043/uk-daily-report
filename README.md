...
每天英国时间 06:00 自动生成并更新的英国热点 Top10 单页日报，可每日查看，也可回溯历史日期。
...
## 每日更新
- GitHub Actions 定时任务：每天 05:00 / 06:00 UTC（= 伦敦 06:00 BST/GMT 全年准点）运行 `scripts/fetch_data.mjs` → `scripts/build_page.mjs`
